...
int main(int argc, const char * argv[]) {
    ...
    unique_ptr<solvers::ISolver> solver = make_unique<solvers::BestFitDecreasing>();
    ...
    std::cout << fixed << setprecision(10) << "Energy consumption of Best Fit decreasing strategy is " << energy << "\n";
